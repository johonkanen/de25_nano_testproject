/*------------------------------------------------------------------------
 * hps_uart1_test.c - minimal bare-metal test for the DE25-Nano HPS UART1
 ...
 * file's header and docs/de25_nano_hps.md) to bring the PLLs up from the
 ...
 * drivers) - see docs/de25_nano_hps.md for the toolchain and build
 * instructions.
 *----------------------------------------------------------------------*/
#include <stdint.h>
